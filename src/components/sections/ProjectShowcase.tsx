  ...
  return (
    <section className="py-24 px-6 border-t border-zinc-800/60">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <p className="text-xs uppercase tracking-widest text-violet-400 font-semibold mb-4">Live project showcase</p>
        ...
        <div className="grid sm:grid-cols-2 gap-5">
          {projects.map((project, i) => (
            <motion.div
              ...
              className={`p-6 bg-zinc-900/60 border ${project.color} rounded-2xl flex flex-col gap-4`}
            >
              ...
              <div>
                <h3 className="font-bold text-zinc-50 text-base mb-2">{project.title}</h3>
