  ...
  return (
    <section className="py-24 px-6 border-t border-slate-100">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <p className="text-xs uppercase tracking-widest text-violet-600 font-semibold mb-4">Course format</p>
        ...
        >
          ...
          <div className="p-6 bg-white border border-slate-100 rounded-2xl shadow-sm">
            <p className="text-xs uppercase tracking-widest text-violet-600 font-semibold mb-5">Workshop details</p>
            <div className="space-y-4">
              {details.map(({ label, value }) => (
                <div key={label} className="flex gap-4">
                  <span className="text-xs text-slate-400 uppercase tracking-wider font-medium w-20 shrink-0 pt-0.5">{label}</span>
          ...
          {/* What to bring */}
          <div className="p-6 bg-white border border-slate-100 rounded-2xl shadow-sm">
            <p className="text-xs uppercase tracking-widest text-violet-600 font-semibold mb-5">What to bring</p>
        ...
        <motion.div
          ...
          className="p-8 bg-slate-50 border border-slate-100 rounded-2xl"
        >
          <p className="text-xs uppercase tracking-widest text-violet-600 font-semibold mb-6">Your instructor</p>
          <div className="flex flex-col md:flex-row gap-6 items-start">
            <div className="shrink-0 w-16 h-16 rounded-xl bg-gradient-to-br from-violet-600 to-indigo-700 flex items-center justify-center text-xl font-bold text-white shadow-lg shadow-violet-900/20">
              PS
            </div>
            <div className="flex-1">
              <h3 className="text-lg font-bold text-slate-900 mb-0.5">Panusorn Srijamorn</h3>
              <p className="text-violet-600 text-sm font-medium mb-4">Head of Technology · Business Consultant · AI & Automation Specialist</p>
              ...
              <div className="flex flex-wrap gap-2 mt-5">
                {tags.map((tag) => (
                  <span key={tag} className="px-3 py-1 bg-slate-100 border border-slate-200 rounded-full text-xs text-slate-600">
                    {tag}
                  </span>
                ))}
              </div>
