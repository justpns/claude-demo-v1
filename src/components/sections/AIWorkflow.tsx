  ...
  return (
    <section className="py-24 px-6 border-t border-zinc-800/60">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <p className="text-xs uppercase tracking-widest text-violet-400 font-semibold mb-4">A new way to work</p>
          <h2 className="text-3xl sm:text-4xl font-bold text-zinc-50 tracking-tight mb-4">
            Stop typing prompts.
            <br />
            <span className="text-zinc-400">Start directing systems.</span>
          </h2>
        ...
        <motion.div
          ...
          className="mb-16 max-w-3xl mx-auto p-6 bg-violet-950/20 border border-violet-800/30 rounded-2xl"
        >
          <p className="text-xs uppercase tracking-widest text-violet-400 font-semibold mb-3">What is vibe coding?</p>
          <p className="text-zinc-200 text-lg leading-relaxed">
            <strong className="text-violet-300">Vibe coding</strong> is the practice of describing what you want to achieve — the outcome, the constraints, the vibe — and letting AI figure out the how. You&apos;re the <em>director</em>. AI is the executor. Syntax doesn&apos;t matter. Intent does.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="p-6 bg-zinc-900/40 border border-zinc-800 rounded-2xl">
            <div className="flex items-center gap-2 mb-5">
              ...
              <p className="text-sm font-semibold text-zinc-400 uppercase tracking-wider">Before</p>
            </div>
            <ul className="space-y-3">
              {before.map((item, i) => (
                <li key={i} className="flex items-start gap-3 text-sm text-zinc-500">
                  <svg className="w-4 h-4 text-red-500/60 shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          ...
          {/* After */}
          <div className="p-6 bg-zinc-900/60 border border-violet-800/30 rounded-2xl">
            <div className="flex items-center gap-2 mb-5">
              <span className="w-2 h-2 rounded-full bg-violet-400" />
              <p className="text-sm font-semibold text-violet-400 uppercase tracking-wider">After vibe coding</p>
            </div>
            <ul className="space-y-3">
              {after.map((item, i) => (
        ...
        >
          <a href="#curriculum" className="text-sm text-violet-400 hover:text-violet-300 transition-colors">
